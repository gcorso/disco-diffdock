...
from datasets_utils.conformer_matching import get_torsion_angles, optimize_rotatable_bonds
...
def get_lig_graph_with_matching(mol_, complex_graph, popsize, maxiter, matching, keep_original, num_conformers, remove_hs):
    if matching:
        ...
        for i in range(num_conformers):
            ...
            complex_graph['ligand'].orig_rdkit_pos = mol_rdkit.GetConformer().GetPositions()
