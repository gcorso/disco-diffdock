...
from models.layers import OldAtomEncoder, AtomEncoder
from models.tensor_layers import GaussianSmearing
from utils import so3, torus
from datasets_utils.process_mols import lig_feature_dims, rec_residue_feature_dims, rec_atom_feature_dims
...
class TensorProductScoreModel(torch.nn.Module):
    def __init__(self, t_to_sigma, device, timestep_emb_func, in_lig_edge_features=4, sigma_embed_dim=32, sh_lmax=2,
                 ...
                 latent_dim=0, latent_vocab=0, latent_cross_attention=False, new_cross_attention=False,
                 cross_attention_heads=1, cross_attention_dim=64, latent_droprate=0.0):

        super(TensorProductScoreModel, self).__init__()
        assert latent_dim == 0, "not implemented yet"
